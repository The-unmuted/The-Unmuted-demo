...
Core features include trusted contact SOS, encrypted evidence storage, post-incident documentation guidance, and access to mental health and legal support resources.

**非默** 是一款面向性骚扰、跟踪、性侵、胁迫、家暴及其他性别伤害场景的双语移动端个人安全工具。

核心功能：可信联系人 SOS、加密存证、事后记录指引，以及心理援助和法律援助资源入口。
