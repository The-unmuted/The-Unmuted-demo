...
const ORGS: LegalOrg[] = [
  ...
  {
    id: "3",
    name: "中国法律援助和司法行政英烈关爱救助基金会",
    nameEn: "China Foundation for Legal Aid and Care for Judicial Heroes",
    type: "legal",
    website: "claf.com.cn",
    websiteUrl: "https://www.claf.com.cn/",
    address: "北京市丰台区六里桥甲1号天程大厦",
    addressEn: "Tiancheng Building, Liuliqiao Jia 1, Fengtai, Beijing",
    hours: "工作日 9:00 – 17:00",
    hoursEn: "Weekdays 9 am – 5 pm",
    description: "官方基金会平台，可查看公益法律援助项目与机构信息；官网未公开全国24小时求助热线",
    descriptionEn: "Official foundation platform for legal aid programs and partner resources; the website does not publish a nationwide 24/7 intake hotline.",
    coverage: "全国",
    coverageEn: "Nationwide",
  },
  {
